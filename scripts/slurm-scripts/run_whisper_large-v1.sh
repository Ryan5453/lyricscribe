...
#SBATCH --job-name=whisper_large-v1
#SBATCH --output=/path/to/your/output/whisper_large-v1.out
...
python -u scripts/whisper-wer.py --directory /path/to/your/audio --model large-v1