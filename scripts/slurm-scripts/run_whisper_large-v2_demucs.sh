...
#SBATCH --job-name=whisper_large-v2_demucs
#SBATCH --output=/path/to/your/output/whisper_large-v2_demucs.out
...
python -u scripts/whisper-wer.py --directory /path/to/your/audio --model large-v2 --use_demucs