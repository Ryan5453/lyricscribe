...
#SBATCH --job-name=whisper_large-v3-turbo
#SBATCH --output=~/music2text/output/whisper_large-v3-turbo_normal.out
...
python whisper-wer.py --directory /path/to/your/audio --model large-v3-turbo
