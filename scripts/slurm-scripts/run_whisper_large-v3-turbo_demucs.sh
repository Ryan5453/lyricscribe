...
#SBATCH --output=/path/to/your/output/whisper_large-v3-turbo_demucs.out
...
python -u scripts/whisper-wer.py --directory /path/to/your/audio --model deepdml/faster-whisper-large-v3-turbo-ct2 --use_demucs