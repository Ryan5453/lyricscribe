...
#SBATCH --job-name=whisper_large-v3
#SBATCH --output=/path/to/your/output/whisper_large-v3.out
...
python -u scripts/whisper-wer.py --directory /path/to/your/audio --model large-v3