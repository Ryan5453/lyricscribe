...
#SBATCH --job-name=whisper_large-v3_demucs
#SBATCH --output=/path/to/your/output/whisper_large-v3_demucs.out
...
python -u scripts/whisper-wer.py --directory /path/to/your/audio --model large-v3 --use_demucs